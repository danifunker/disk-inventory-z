	  ...
	  options: (NSDictionary*) options
{
	...
	{
		LOG( @"binding '%@': object: %p (%@), key path: %@, options: %@", binding, observableController, [observableController class], keyPath, options );
	...
	{
		LOG( @"unknown binding '%@' requested: object: %p (%@), key path: %@, options: %@", binding, observableController, [observableController class], keyPath, options );
